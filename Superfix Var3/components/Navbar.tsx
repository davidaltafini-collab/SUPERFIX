      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex md:items-center">
            ...
            {/* === AICI AM ADĂUGAT BUTONUL NOU === */}
            <Link to="/hero-portal" className={navLinkClass('/hero-portal')}>PORTAL EROI</Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 border-t-2 border-dashed border-gray-300 mt-2 pt-2 animate-slide-up">
            ...
            {/* === AICI AM ADĂUGAT BUTONUL NOU PENTRU MOBIL === */}
            <Link to="/hero-portal" onClick={() => setIsOpen(false)} className={navLinkClass('/hero-portal')}>PORTAL EROI</Link>
